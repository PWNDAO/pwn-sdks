...
import type { ProposalSpecificDataSchemaWorkaround } from "./proposal-specific-data-schema-workaround";
...
export interface ProposalAndLoanListSchemaWorkaround {
	...
	proposalSpecificData: ProposalSpecificDataSchemaWorkaround;
}
