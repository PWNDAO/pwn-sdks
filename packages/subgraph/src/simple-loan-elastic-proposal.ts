...
import { SimpleLoanElasticProposalProposalMade } from "../generated/schema"

export function handleProposalMade(event: ProposalMadeEvent): void {
  const entity = new SimpleLoanElasticProposalProposalMade(
  ...
  entity.proposal_creditPerCollateralUnit =
