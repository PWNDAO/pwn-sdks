...
import { SimpleLoanListProposalProposalMade } from "../generated/schema"

export function handleProposalMade(event: ProposalMadeEvent): void {
  const entity = new SimpleLoanListProposalProposalMade(
  ...
  entity.proposal_collateralIdsWhitelistMerkleRoot =
